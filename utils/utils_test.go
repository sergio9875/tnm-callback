...
func TestSafeAtoi(t *testing.T) {
	result := SafeAtoi("123weq", IntPtr(321))
	if *result != 321 {
		t.Errorf("SafeAtoi test failed, expected[321], got[%d]", result)
	}
	result = SafeAtoi("123", IntPtr(321))
	if *result != 123 {
		t.Errorf("SafeAtoi test failed, expected[123], got[%d]", result)
	}
}

func TestSafeAtoi64(t *testing.T) {
	result := SafeAtoi64("123weq", Int64Ptr(321))
	if *result != 321 {
		t.Errorf("SafeAtoi test failed, expected[321], got[%d]", result)
	}
	result = SafeAtoi64("123", Int64Ptr(321))
	if *result != 123 {
		t.Errorf("SafeAtoi test failed, expected[123], got[%d]", result)
	}
}

func TestSafeAtof(t *testing.T) {
	result := SafeAtof("123weq", 321.1)
	if result != 321.1 {
		t.Errorf("SafeAtoi test failed, expected[321], got[%f]", result)
	}
	result = SafeAtof("123.1234", 321.321)
	if result != 123.1234 {
		t.Errorf("SafeAtoi test failed, expected[123], got[%f]", result)
	}
}
...
func TestIntPtr(t *testing.T) {
	value := IntPtr(321)
	if value == nil {
		t.Error("IntPtr test failed nil pointer returned")
		return
	}
	if *value != 321 {
		t.Errorf("IntPtr test failed, expected[321], got[%d]", *value)
	}
}
...
func TestInt64Ptr(t *testing.T) {
	value := Int64Ptr(321)
	if value == nil {
		t.Error("Int64Ptr test failed nil pointer returned")
		return
	}
	if *value != int64(321) {
		t.Errorf("Int64Ptr test failed, expected[321], got[%d]", *value)
	}
}
...
func TestXmlIt(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: "<Tester><InResult>321</InResult></Tester>",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := XmlIt(tt.args.a); got != tt.want {
				t.Errorf("XmlIt() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestIndirectType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := IndirectType(tt.args.reflectType); !reflect.DeepEqual(got, tt.want) {
...
func TestResponseWriterText(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ResponseWriterText(tt.args.writer, tt.args.response)
			if recorder.Result().Header.Get(ContentTypeHeader) != ContentTypeTextPlain {
				t.Errorf(" ResponseWriterText was expecting %s, got %s", ContentTypeTextPlain,
					recorder.Result().Header.Get(ContentTypeHeader))
			}
		})
	}
}
